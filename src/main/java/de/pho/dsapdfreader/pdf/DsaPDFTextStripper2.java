...
public class DsaPDFTextStripper2 extends PDFTextStripper
{
     ...
     */
    public DsaPDFTextStripper2(String publication, TopicEnum topic) throws IOException
    {
        super();
        ...
        super.setParagraphStart("### PS ###");
        super.setParagraphEnd("### PE ###");
        super.setArticleStart("--- AS ---");
        super.setArticleEnd("--- AE ---");
    ...
    private void buildResultTexts()
    {
        ...
        charactersByArticle.forEach(a -> {
            a.forEach(tp -> {

                boolean isBold = tp.getFont().toString().contains("Bold") || tp.getFont().toString().equals("PDType0Font/PDCIDFontType2, PostScript name: HPQTGU+GentiumBasic");
