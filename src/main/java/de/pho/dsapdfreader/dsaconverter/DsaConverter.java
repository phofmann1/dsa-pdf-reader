...
{
    // TODO: move keys to Implementation!!
    ...
    public List<T> convertTextWithMetaInfo(List<TextWithMetaInfo> resultList, TopicConfiguration conf)
    {
        ...
        concludeVariantsOfPredecessor(returnValue); //finish the last entry in list
        return returnValue;
    }
    ...
    private void concludeVariantsOfPredecessor(List<T> elementList)
    {
        ...
        if (element instanceof MysticalSkillRaw ms && ms.variantsText != null)
        {
            ...
            List<Triplet<Integer, Integer, String>> variantTitleMatches = extractVariantTitles(ms);
    ...
    protected void applyFlagsForQs(AtomicConverterFlag flags, String text)
    {
    ...
    protected void handleWasQsValues(AtomicConverterFlag flags, TextWithMetaInfo t)
    {
